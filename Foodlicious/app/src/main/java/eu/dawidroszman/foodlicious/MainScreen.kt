...
fun Content(modifier: Modifier, photoViewModel: PhotoViewModel){
    ...
    Column(modifier = modifier
        ...
        Column(modifier = Modifier.padding(10.dp)) {
            Item("Origin", photoViewModel.photoUiState.origin)
            Item(title = "Type", description = photoViewModel.photoUiState.type)
            Item(title = "Season", description = photoViewModel.photoUiState.season)
            Item(title = "Description", description = photoViewModel.photoUiState.description)
            Item(title = "Nutrients", description = photoViewModel.photoUiState.nutrients)
        }
    }
}
